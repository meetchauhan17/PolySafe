...
function CascadeMatchCard({ match, description }) {
 ...
 <div className="p-5 bg-[var(--chassis)] border-2 border-[var(--led-caution)]/50 rounded-2xl space-y-3">
 <div className="flex items-start gap-3">
 <div className="p-2 bg-[var(--led-caution)]/10 rounded-xl flex-shrink-0">
 <AlertTriangle className="w-5 h-5 text-[var(--led-caution)]" />
 </div>
 <div>
 <p className="text-[10px] font-extrabold uppercase tracking-widest text-[var(--led-caution)]">
 ...
 on{' '}
 <strong className="text-[var(--text-primary)]">{formatDate(match.dateStarted)}</strong>.{' '}
 The symptom{' '}
 <em>"{match.symptomKeyword}"</em>{' '}
 is a known possible side effect of{' '}
 <strong className="text-[var(--text-primary)]">{match.causingDrugCategory}</strong>{' '}
 medicines.
 </p>

 {/* Key callout */}
 <div className="p-4 bg-[var(--chassis-dark)] shadow-[var(--shadow-recessed)] border border-[var(--led-caution)]/30 rounded-xl flex items-start gap-2.5">
 <MessageSquare className="w-4 h-4 text-[var(--led-caution)] flex-shrink-0 mt-0.5" />
 ...
 className="space-y-3"
 >
 <div className="flex items-start space-x-3 p-3.5 bg-[var(--chassis)] border border-[var(--brand-border-subtle)] rounded-xl">
 <div className="p-2 bg-[var(--accent-primary)]/10 rounded-lg flex-shrink-0">
 <Pill className="w-4 h-4 text-[var(--accent-primary)]" />
 </div>
 <div className="flex-1">
 <p className="text-sm font-bold text-[var(--text-primary)]">{match.medicineName}</p>
 ...
 <span className="text-[10px] text-[var(--text-muted)]">{match.medicineDosage}</span>
 )}
 <span className="text-[10px] px-2 py-0.5 bg-[var(--chassis)] border border-[var(--brand-border-subtle)] rounded-md text-[var(--text-muted)] font-semibold">
 ...
 icon={<MessageSquare className="w-4 h-4 text-[var(--accent-primary)]" />}
 className="space-y-3"
 >
 <div className="p-4 bg-[var(--chassis)] border border-[var(--accent-primary)]/30 rounded-xl shadow-[var(--shadow-recessed)]">
 ...
 {/* Safety notice */}
 <div className="flex items-start space-x-2.5 p-4 border-2 border-[var(--brand-border-subtle)] bg-[var(--chassis)] rounded-2xl">
...
function NoCascadeCard({ description }) {
 ...
 <Card variant="safe" className="bg-[var(--chassis)] border border-[var(--led-safe)]/30 space-y-3 shadow-[var(--shadow-card)]">
 <div className="flex items-start gap-3">
 <div className="p-2 bg-[var(--led-safe)]/10 rounded-xl flex-shrink-0">
 <CheckCircle2 className="w-5 h-5 text-[var(--accent-primary)]" />
 </div>
 <div>
 <p className="text-[10px] font-extrabold uppercase tracking-widest text-[var(--accent-primary)]">
 No known link found
 </p>
 <h2 className="text-lg font-bold text-[var(--text-primary)] mt-0.5" >
 ...
 <div className="p-4 bg-[var(--chassis-dark)] shadow-[var(--shadow-recessed)] border border-[var(--led-safe)]/30 rounded-xl space-y-1.5">
 <div className="flex items-center gap-2">
 <MessageSquare className="w-4 h-4 text-[var(--accent-primary)] flex-shrink-0" />
...
export default function SymptomResultPage() {
 ...
 <HeartPulse className="w-12 h-12 text-[var(--accent-primary)] mx-auto" />
 <h2 className="text-xl font-bold text-[var(--text-primary)]">No symptom data found</h2>
 <p className="text-sm text-[var(--text-muted)]">Please log a symptom first to see cascade analysis results.</p>
