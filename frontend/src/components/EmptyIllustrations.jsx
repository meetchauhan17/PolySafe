...
export function EmptyMedicinesIllustration({ className = 'w-36 h-36 mx-auto' }) {
 ...
 <circle cx="80" cy="80" r="64" fill="var(--chassis)" fillOpacity="0.5" />
 <circle cx="80" cy="80" r="54" stroke="var(--accent-primary)" strokeOpacity="0.15" strokeWidth="1.5" strokeDasharray="3 3" />
 ...
 {/* Bottle Neck */}
 <rect x="22" y="14" width="20" height="4" fill="#FFFFFF" stroke="var(--accent-primary)" strokeWidth="2" strokeLinejoin="round" />
 ...
 {/* Dosage lines */}
 <line x1="22" y1="58" x2="42" y2="58" stroke="var(--text-muted)" strokeWidth="1.5" strokeLinecap="round" opacity="0.5" />
 </g>
 ...
 <circle cx="36" cy="116" r="10" fill="#FFFFFF" stroke="var(--accent-primary)" strokeWidth="2" />
 <line x1="29" y1="116" x2="43" y2="116" stroke="var(--accent-primary)" strokeWidth="1.5" strokeLinecap="round" />

 {/* Delicate Herbal Leaf Branch */}
 <path d="M112 44C118 42 126 46 128 54C120 56 114 52 112 44Z" fill="var(--accent-primary)" fillOpacity="0.15" stroke="var(--accent-primary)" strokeWidth="1.75" strokeLinejoin="round" />
 <path d="M128 54C134 56 138 64 136 72C128 72 124 66 128 54Z" fill="var(--accent-primary)" fillOpacity="0.15" stroke="var(--accent-primary)" strokeWidth="1.75" strokeLinejoin="round" />
...
export function EmptyDoctorsIllustration({ className = 'w-36 h-36 mx-auto' }) {
 ...
 />
 {/* Earpieces */}
 <circle cx="48" cy="42" r="4.5" fill="var(--accent-secondary)" />
 <circle cx="112" cy="42" r="4.5" fill="var(--accent-secondary)" />
 <path d="M48 42H56" stroke="var(--accent-secondary)" strokeWidth="2" strokeLinecap="round" />
 <path d="M104 42H112" stroke="var(--accent-secondary)" strokeWidth="2" strokeLinecap="round" />

 {/* Stem & Chestpiece */}
 <path d="M80 98V114" stroke="var(--accent-secondary)" strokeWidth="2.5" strokeLinecap="round" />
 <circle cx="80" cy="122" r="10" fill="#FFFFFF" stroke="var(--accent-secondary)" strokeWidth="2.5" />
 <circle cx="80" cy="122" r="4" fill="var(--accent-primary)" />
 ...
 />
 {/* Cross */}
 <path d="M18 13V27M11 20H25" stroke="var(--accent-primary)" strokeWidth="2" strokeLinecap="round" />
 </g>

 {/* QR Code link accent */}
 <g transform="translate(112, 102)">
 <rect x="0" y="0" width="22" height="22" rx="4" fill="#FFFFFF" stroke="var(--accent-primary)" strokeWidth="1.5" />
...
export function EmptyCaregiversIllustration({ className = 'w-36 h-36 mx-auto' }) {
 ...
 >
 {/* Ambient background */}
 <circle cx="80" cy="80" r="64" fill="var(--chassis)" fillOpacity="0.45" />
...
export function EmptyDoctorPatientIllustration({ className = 'w-36 h-36 mx-auto' }) {
 ...
 {/* Board Body */}
 <rect x="4" y="6" width="68" height="96" rx="8" fill="#FFFFFF" stroke="var(--accent-secondary)" strokeWidth="2" strokeLinejoin="round" />

 {/* Medical Chart Lines */}
 <line x1="16" y1="24" x2="48" y2="24" stroke="var(--accent-primary)" strokeWidth="2.5" strokeLinecap="round" />
 <line x1="16" y1="34" x2="60" y2="34" stroke="var(--text-muted)" strokeWidth="1.75" strokeLinecap="round" opacity="0.4" />
 <line x1="16" y1="42" x2="52" y2="42" stroke="var(--text-muted)" strokeWidth="1.75" strokeLinecap="round" opacity="0.4" />
 ...
 <line x1="16" y1="76" x2="38" y2="76" stroke="var(--text-muted)" strokeWidth="1.75" strokeLinecap="round" opacity="0.4" />
 <line x1="16" y1="84" x2="48" y2="84" stroke="var(--text-muted)" strokeWidth="1.75" strokeLinecap="round" opacity="0.4" />
 </g>
 ...
 strokeLinecap="round"
 />
 <circle cx="112" cy="88" r="8" fill="#FFFFFF" stroke="var(--accent-primary)" strokeWidth="2" />
 <circle cx="112" cy="88" r="3.5" fill="var(--accent-primary)" />
 </svg>
 );
}
...
export function EmptyTrendsIllustration({ className = 'w-36 h-36 mx-auto' }) {
 ...
 {/* Y Axis & X Axis */}
 <line x1="16" y1="12" x2="16" y2="88" stroke="var(--accent-primary)" strokeWidth="2" strokeLinecap="round" />
 <line x1="16" y1="88" x2="94" y2="88" stroke="var(--accent-primary)" strokeWidth="2" strokeLinecap="round" />

 {/* Dotted Grid Guidelines */}
 <line x1="16" y1="36" x2="94" y2="36" stroke="var(--accent-primary)" strokeWidth="1.25" strokeDasharray="3 3" strokeOpacity="0.25" />
 <line x1="16" y1="62" x2="94" y2="62" stroke="var(--accent-primary)" strokeWidth="1.25" strokeDasharray="3 3" strokeOpacity="0.25" />
 ...
 <circle cx="16" cy="16" r="14" fill="#FFFFFF" stroke="var(--accent-primary)" strokeWidth="2" />
 <path d="M16 8V16L22 20" stroke="var(--accent-primary)" strokeWidth="1.5" strokeLinecap="round" />
 <line x1="26" y1="26" x2="38" y2="38" stroke="var(--accent-primary)" strokeWidth="2.5" strokeLinecap="round" />
 </g>
