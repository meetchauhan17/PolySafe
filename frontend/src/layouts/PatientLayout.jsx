 ...
 *
 * Structure:
 * - Clean Top Bar: Logo + App name + Sign Out (no cluttered desktop nav)
...
export default function PatientLayout() {
  ...
  return (
    <div className="min-h-screen bg-[#FBF8F2] text-[#232724] flex flex-col font-sans selection:bg-[#2B6E5E] selection:text-white">
      ...
      <header className="sticky top-0 z-40 bg-[#FBF8F2]/90 backdrop-blur-md border-b-2 border-[#E7E1D3] px-4 py-3">
